...
export default function Header() {
  ...
  const menuItems = [
    { label: 'Why', href: '/#problem', ids: ['problem'] },
    { label: '6-Layer Concept', href: '/#layers', ids: ['layers'] },
    { label: 'Agent Workforce', href: '/#agents', ids: ['agents'] },
    { label: 'Reverse Engineering', href: '/#reverse', ids: ['reverse'] },
    { label: 'Templates', href: '/#portability', ids: ['portability'] },
    { label: 'Enterprise', href: '/#enterprise', ids: ['enterprise'] },
